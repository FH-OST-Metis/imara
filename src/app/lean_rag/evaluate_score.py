...
def main():
    query_file = f"{DATASET_ROOT}/{DATASET}_query_answer.jsonl"
    result_file = f"{DATASET_ROOT}/{DATASET}_query_answer.jsonl"
    output_file = f"{DATASET_ROOT}/{DATASET}_local_result.jsonl"
    tokenizer=tiktoken.get_encoding("cl100k_base")

    total_token_cost = evaluate_example(query_file, result_file, output_file, DATASET, tokenizer)
