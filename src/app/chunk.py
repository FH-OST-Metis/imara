...
def main():
    ...
    parser = argparse.ArgumentParser(description="Chunk extracted files from data extracted to data chunks directory.")
    ...
    with mlflow.start_run(run_name="chunk"):
        total_size = 0
        total_files = 0
        ...
        mlflow.log_param("total_files_chunked", total_files)
        mlflow.log_param("total_size_chunked", total_size)
        print("✅ Done: all files chunked recursively.")
