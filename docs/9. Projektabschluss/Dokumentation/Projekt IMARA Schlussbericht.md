...
- [Projektbericht: IMARA](#projektbericht-imara)
  ...
  - [4. Methodik / Umsetzung](#4-methodik--umsetzung)
    ...
    - [4.5 Naives RAG (Baseline)](#45-naives-rag-baseline)
      - [4.5.1 Chunking und Datenpersistierung](#451-chunking-und-datenpersistierung)
      - [4.5.2 Embedding, Retrieval und Baseline-Charakter](#452-embedding-retrieval-und-baseline-charakter)
    ...
    - [4.7 GraphMERT](#47-graphmert)
      ...
      - [Die „Leafy Chain Graph“-Struktur](#die-leafy-chain-graph-struktur)
      - [H-GAT (Hierarchical Graph Attention)](#h-gat-hierarchical-graph-attention)
      - [Implementation Version 1](#implementation-version-1)
      - [Impementation Version 2](#impementation-version-2)
  ...
  - [5. Resultate](#5-resultate)
    ...
    - [5.3 LinearRAG](#53-linearrag)
      - [5.3.1 Ausgangslage](#531-ausgangslage)
      - [5.3.2 Graphstruktur und Umfang](#532-graphstruktur-und-umfang)
      - [5.3.3 TF-IDF-Gewichtung](#533-tf-idf-gewichtung)
      - [5.3.4 Graph-Sparsität](#534-graph-sparsität)
...
2. **Retrieval (Abruf):** Sie nimmt eine Benutzeranfrage entgegen, wandelt sie in einen Vektor um und durchsucht den Graphen nach den ähnlichsten Knoten.

3. **Generierung:** Sie übergibt den abgerufenen Text an ein LLM, um die Frage zu beantworten.
